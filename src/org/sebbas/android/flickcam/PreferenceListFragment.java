...
public class PreferenceListFragment extends ListFragment{
    ...
    public void onDestroyView(){
        super.onDestroyView();
        ViewParent p = mListView.getParent();
        if(p != null)
            ((ViewGroup)p).removeView(mListView);
    }
    ...
    public void onCreate(Bundle b) {
        ...
        mListView = (ListView) LayoutInflater.from(getActivity()).inflate(R.layout.preference_list_content, null);
